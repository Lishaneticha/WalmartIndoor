...
fun StoreLayoutCanvas2(
    ...
    BoxWithConstraints(
        ...
        // Drawing bounds from original map
                    ...
                    .pointerInput(Unit) {
                        detectTapGestures(
                            onPress = { rawTapOffset ->
                                ...
                                rects.forEachIndexed { index, (topLeft, size) ->
                    ...
                    .pointerInput(Unit) {
                        detectTapGestures(
                            onPress = { rawTapOffset ->
                                ...
                                Log.d("Touch", "Raw tap: $rawTapOffset, Adjusted: $adjustedTapOffset")
